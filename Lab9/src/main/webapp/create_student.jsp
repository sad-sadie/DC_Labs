    ...
    <div class="row">
      <div class="card card-signup" data-background-color="black">
        <form action="../home" method="post" enctype="multipart/form-data">
          <input name="command" type="hidden" value="createStudent">
          <div class="card-header text-center">
            <h3 class="card-title title-up">Create new student</h3>
          </div>
          <div class="card-body">
          ...
          <div class="card-footer text-center">
            <button class="btn btn-danger btn-round btn-lg" type="submit">Create student</button>
          </div>
        </form>
      </div>
    </div>
