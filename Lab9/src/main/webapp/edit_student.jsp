    ...
    <div class="row">
      <div class="card card-signup" data-background-color="black">
        <form action="../home" method="post" enctype="multipart/form-data">
          <input name="command" type="hidden" value="getEditedStudent">
          ...
          <div class="card-body">
            ...
            <input name="groupId" type="hidden" value=${student.groupId}>

          </div>
          <div class="card-footer text-center">
            <button class="btn btn-danger btn-round btn-lg" type="submit">Edit student</button>
          </div>
        </form>
      </div>
    </div>
