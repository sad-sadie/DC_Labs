        ...
        <div class="row">
            <div class="card card-signup" data-background-color="black">
                <form action="../home" method="post" enctype="multipart/form-data">
                    <input name="command" type="hidden" value="createGroup">
                    <div class="card-header text-center">
                        <h3 class="card-title title-up">Create new group</h3>
                    </div>
                    <div class="card-body">
                  ...
                  <span class="input-group-text">
                    <i class="now-ui-icons users_circle-08"></i>
                            ...
                            <input type="number" name="course" placeholder="Enter course">
                        </div>


                    </div>
                    <div class="card-footer text-center">
                        <button class="btn btn-danger btn-round btn-lg" type="submit">Create group</button>
                    </div>
                </form>
            </div>
        </div>
